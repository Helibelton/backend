package com.genesis.mtoUsers.controllers;
...
import com.genesis.mtoUsers.service.UserService;
import com.genesis.mtoUsers.util.RestResponse;
...
public class UserController {
	...
	public void deleteUser(@RequestBody String userJson) throws Exception {
		...
		if(user.getId() == null) {
			throw new Exception("El id esta nulo o vacio");
		}
